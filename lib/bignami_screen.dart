        ...
        children: [
          ...
          _Panel(
            ...
            children: [
              ...
              _P('Classificazione delle nubi per famiglia (quota della base, media latitudine):'),
              _Bullet('Alte (CI, CC, CS) — 6000-12000m, cristalli di ghiaccio, aspetto filamentoso/a banchi sottili'),
              _Bullet('Medie (AC, AS) — 2000-6000m, prefisso "alto-"'),
              _Bullet('Basse (ST, SC, NS) — suolo-2000m, NS = nembostrato, precipitazione continua'),
              _Bullet('Sviluppo verticale (CU, CB) — base bassa ma sommita\' anche in stratosfera; CB = cumulonembo, turbolenza/grandine/wind shear severi'),
              _Mnemo('il prefisso "cirro-"/"cirrus" = sempre quota alta; "nembo-"/"nimbus" = sempre nube da precipitazione (bassa o a sviluppo verticale).'),
              _P('Precipitazione in base alla nube di origine:'),
              _Bullet('ST → pioviggine (drizzle), leggera e continua'),
              _Bullet('NS/AS spessi → pioggia/neve continua e diffusa su area estesa'),
              _Bullet('CU/CB → rovesci (showers), intensi, localizzati e intermittenti'),
              _Bullet('CB maturo → possibile grandine e virga (precipitazione che evapora prima di toccare il suolo)'),
              _Mnemo('nube stratificata = precipitazione continua e uniforme; nube a sviluppo verticale = rovescio intenso e breve.'),
              _P('Fronti: zona di transizione tra due masse d\'aria, simbolo diverso sulle carte per ciascuno:'),
              _Bullet('Freddo — triangoli pieni rivolti nel senso di avanzamento; aria fredda cuneifica sotto la calda, avanzamento rapido, temporali/rovesci intensi ma brevi'),
              _Bullet('Caldo — semicerchi pieni rivolti nel senso di avanzamento; aria calda scivola sopra la fredda con pendenza dolce, nuvolosita\' stratificata e precipitazione continua anche ore prima del passaggio'),
              _Bullet('Occluso — triangoli e semicerchi alternati sullo stesso lato della linea; il fronte freddo, piu\' veloce, ha raggiunto quello caldo'),
              _Bullet('Stazionario — triangoli e semicerchi alternati su lati opposti della linea; nessuna massa prevale, il fronte non avanza'),
              _Mnemo('il simbolo sta sempre dalla parte verso cui il fronte si muove; freddo = spigoloso e veloce, caldo = arrotondato e lento.'),
              _P('Simbologia del vento sulle carte meteo (frecce con barbe):'),
              _Bullet('la freccia punta verso dove soffia il vento (direzione di destinazione)'),
              _Bullet('barbe sulla coda = intensita\': barba corta 5kt, barba lunga 10kt, triangolo pieno (bandierina) 50kt, si sommano'),
              _Example('due barbe lunghe + una corta = 25kt'),
              _Mnemo('non confondere: in fraseologia radio/METAR il vento e\' sempre riferito alla provenienza; sulle carte sinottiche la freccia indica invece la direzione verso cui soffia.'),
          ...
          _Panel(
            ...
            children: [
              ...
              _Bullet('Peso operativo a vuoto (OEW) — peso a vuoto equipaggiato + equipaggio + relativi bagagli; NON include ancora pax/carico pagante/carburante'),
              _Bullet('Peso a zero carburante (ZFW) — peso totale dell\'aeromobile carico (equipaggio+pax+bagagli) ma senza carburante imbarcato'),
              ...
              _Formula(
                  'Carico utile = MTOW − Peso a vuoto equipaggiato\nZFW = Peso operativo a vuoto + carico pagante (pax+bagagli)\nPeso al decollo = ZFW + carburante imbarcato'),
              _Mnemo('"a secco" = zero fluidi consumabili, è sempre il numero più basso; il carburante è l\'ultimo addendo che si aggiunge in ogni catena di pesi, mai prima del carico pagante.'),
            ],
          ),
          _Panel(
          ...
          _Panel(
            ...
            children: [
              ...
              _P('Errori della bussola magnetica in virata (solo su prue N/S), da tenere separati:'),
              _Bullet('Virando per Nord: la bussola indica prima di raggiungerlo → si esce dalla virata in anticipo'),
              _Bullet('Virando per Sud: la bussola indica dopo averlo superato → si esce dalla virata in ritardo'),
              _Mnemo('UNOS: Undershoot North, Overshoot South.'),
              _P('Errori della bussola in accelerazione/decelerazione (solo su prue E/O), volo livellato:'),
              _Bullet('Accelerando: la bussola vira apparentemente verso Nord'),
              _Bullet('Decelerando: la bussola vira apparentemente verso Sud'),
              _Mnemo('ANDS: Accelerate North, Decelerate South.'),
              _P('Precessione giroscopica: una forza applicata a una massa rotante (girobussola, orizzonte artificiale) si manifesta non nel punto di applicazione ma 90° più avanti nel senso di rotazione.'),
            ],
          ),
          _Panel(
            title: 'Comunicazioni',
